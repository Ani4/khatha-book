...
<div className="container" style={{paddingTop: 20}}>
  <div className="row">
    <div className="col-sm-6">
      ...
      <p className="text-primary m-0 font-weight-bold">Bill Number&nbsp;</p>
        <input className="form-control" data-container=".row" placeholder="Bill Number" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Must be at least 5 characters long, and must only contain letters." type="text" />
      </div>
      <div className="form-group has-feedback">
      <p className="text-primary m-0 font-weight-bold">Bill Name&nbsp;</p>
        <input className="form-control" data-container=".row" placeholder="Bill Name" data-toggle="popover" data-trigger="hover" data-placement="right" data-content="Must be at least 5 characters long, and must only contain letters." type="text" />
        
      </div>
      <div className="row justify-content-md-center" style={{paddingTop: 20}}>
      <a class="btn btn-primary btn-lg d-none d-sm-inline-block "  role="button" href="#"><i class="fas fa-upload fa-sm text-white-50"></i>&nbsp;Submit</a>
      </div>
      
    </div>

    <div className="container col"><div className="bootstrap_img_upload">
